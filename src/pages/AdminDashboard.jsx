...
const DashboardOverview = () => {
    ...
    const teamStats = useMemo(() => {
        ...
        // 2. Calcula médias focadas apenas na SEMANA ATUAL
        ...
        if (currentWeek.length > 0) {
            currentWeek.forEach(e => {
                ...
                // Calcula os pontos dessa avaliação específica para a média semanal
    ...
    return (
        <div className="flex-1 p-6 h-full overflow-y-auto">
            ...
            <div className="mb-8">
                ...
                {/* Alterado para grid-cols-4 para acomodar o novo card */}
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    {/* NOVO CARD: Média de Pontos da Semana Separada por Turno */}
